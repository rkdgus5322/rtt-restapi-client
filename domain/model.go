...
type Body struct {
	...
	ISSUYEAR        string `json:"ISSU_YEAR" gorm:"column:issu_year"`
	ISSUMONTH       string `json:"ISSU_MONTH" gorm:"column:issu_month"`
	SIDOCODE        string `json:"SIDO_CODE" gorm:"column:sido_code"`
	SIDONAME        string `json:"SIDO_NAME" gorm:"column:sido_name"`
	SIGUNGUCODE     string `json:"SIGUNGU_CODE" gorm:"column:sigungu_code"`
	SIGUNGUNAME     string `json:"SIGUNGU_NAME" gorm:"column:sigungu_name"`
	DONGCODE        string `json:"DONG_CODE" gorm:"column:dong_code"`
	DONGNAME        string `json:"DONG_NAME" gorm:"column:dong_name"`
	AGEGROUP        string `json:"AGE_GROUP" gorm:"column:age_group"`
	SEX             string `json:"SEX" gorm:"column:sex"`
	USEDNUMBERINDEX string `json:"USED_NUMBER_INDEX" gorm:"column:used_number_index"`
	USEDAMTINDEX    string `json:"USED_AMT_INDEX" gorm:"column:used_amt_index"`
}
